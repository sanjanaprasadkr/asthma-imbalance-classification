...
#setwd("C:/Users/yashr/OneDrive/Desktop/CollegeStuff/MET-CS-699-Data-Mining/Project/SampledDatasets/NewDatasets")
...
#rus_lda <- read.csv("new_rus_lda_train.csv")
#rus_info_gain <- read.csv("new_rus_info_gain_train.csv")
